...
export const Header: React.FC = () => {
  return (
    <header className="w-full bg-[#0b1224]/80 backdrop-blur-md border-b border-[#1d2940] sticky top-0 z-30">
      ...
      <div className="max-w-[1080px] mx-auto px-4 py-3 sm:py-4 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3.5 text-center sm:text-left">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight flex items-center justify-center sm:justify-start gap-2">
              Indian Card Generator
            </h1>
            <p className="text-xs sm:text-sm text-[#dfe2e8] font-medium">
        ...
        <div className="hidden md:flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-amber-500/40 bg-amber-950/20 text-amber-300 text-xs sm:text-sm font-semibold shadow-sm">

...
export const SocialPromo: React.FC = () => {
  return (
    <a
      ...
      className="group block w-full bg-[#000000] hover:bg-[#080d19] border border-[#172238] hover:border-[#ff9800]/50 rounded-2xl p-5 text-center transition-all shadow-xl focus-visible:ring-2 focus-visible:ring-[#ff9800] outline-none"
    >
      <div className="flex flex-col items-center justify-center gap-2.5">
        {/* Social Icons Badge */}
        <div className="flex items-center gap-2 p-1.5 px-3 rounded-full bg-[#111a2d] border border-[#26344d]">
        ...
        <p className="text-sm font-bold text-[#ff9800] group-hover:text-[#ffa726] flex items-center gap-1.5 transition-colors">
